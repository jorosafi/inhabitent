 ...
 * @author    Rodrigo Samayoa <jorosafi@gmail.com>
 * @license   GPL-2.0+
 * @link      https://github.com/jorosafi
 * @copyright 2015 Your Name or Company Name
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hours Widget
 * Plugin URI:        @TODO
 * Description:       Shows Business Hours
 * Version:           1.0.0
 * Author:            Rodrigo Samayoa
 * Author URI:        https://github.com/jorosafi
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'A widget to show business hours'
			)
		);
